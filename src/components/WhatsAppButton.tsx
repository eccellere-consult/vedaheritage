...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white rounded-full shadow-lg px-4 py-3 hover:bg-[#1ebe5d] transition-colors duration-200 group"
    ...
    >
      ...
      <span className="text-sm font-medium whitespace-nowrap hidden sm:block">Chat with us</span>
    </a>
  )
}
